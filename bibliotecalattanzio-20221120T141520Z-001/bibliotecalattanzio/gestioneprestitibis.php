...
<html>
    ...
    <body>
      <section>
        ...
        <!-- se il prestito viene eliminato -->
        <div id="coprente">
        <div id="div2">
          <?php
          $id = $_GET["id"];
          ...
          $datar = $_GET["datar"];
          echo "<br>";
          echo "<form action='esegui.php?id=$id&libro=$libro&utente=$utente&datap=$datap&datar=$datar&azione=ELIMINA_PRESTITO' method='POST'>";
          ...
          echo "<button class='button-l' type='submit'>Conferma</button></form><form action='gestioneprestiti.php'><button class='button-r'>Torna indietro</button></form>";
          echo "</div>";
