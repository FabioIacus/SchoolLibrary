...
<html>
    <head>
        <title>Inserimento Documento</title>
...
if(theEvent.preventDefault) theEvent.preventDefault();
    ...
    <a style="cursor: pointer" class="black" onclick="javascript:history.go(-1)" data-toggle="tooltip" title="Torna indietro"><i class="material-icons">&#xe5c4;</i></a>
        ...
        <h1>Carica video</h1>
      <form action="esegui.php?azione=AGGIUNGI_DOCUMENTO" method="post" enctype="multipart/form-data">
          Seleziona documento da caricare:
          ...
          <br>
          <input type="submit" value="Carica documento" name="upload">
        </form>
