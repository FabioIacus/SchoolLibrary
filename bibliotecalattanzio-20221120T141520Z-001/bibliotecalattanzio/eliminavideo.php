...
<html>
    ...
    <a style="cursor: pointer" class="black" onclick="javascript:history.go(-1)" data-toggle="tooltip" title="Torna indietro"><i class="material-icons">&#xe5c4;</i></a>
        ...
        <h1>Elimina video</h1>
			  <p>
        <form action="esegui.php?azione=ELIMINA_VIDEO" method="POST">
        <p>
				Seleziona video:
        <?php
        ...
        $query="SELECT * from condividere3, video where video.id = condividere3.video and condividere3.insegnante = " . $_SESSION["idutente"] . " order by condividere3.video";
